...
export class Scraper {
  ...
  async erikshjalpenSubScraper (url) {
    try {
      ...
      console.error('Error occurred in erikshjalpenSubScraper:', error)
    }
  }
  ...
  async lakarmissionenItemScraper (url) {
    try {
      ...
      console.error('Error occurred in lakarmissionenItemScraper:', error)
    }
  }
  ...
  async rodaKorsetProductScraper (url) {
    try {
      ...
      console.error('Error occurred in rodaKorsetProductScraper:', error)
    }
  }
